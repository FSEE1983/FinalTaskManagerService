...
namespace TaskManegerService.Controllers.Tests
{
    ...
    public class TaskControllerTests
    {
        ...
        public void InitializeTest()
        {
            ...
            repository.Setup(x => x.EndTask(It.IsAny<int>())).Callback((int id) => tasks.RemoveAt(tasks.IndexOf(tasks.Where(x => x.Task_ID == id).FirstOrDefault())));
